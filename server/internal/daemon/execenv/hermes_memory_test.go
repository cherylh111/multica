...
func TestPrepareHermesHomeMemoryStorePersistsAcrossTasks(t *testing.T) {
	...
	if _, err := prepareHermesHome(firstTask, sharedHome, false, skills, nil, store, "", nil, testLogger()); err != nil {
...
func TestPrepareHermesHomeMemoryStoreIsolatesAgents(t *testing.T) {
	...
	if _, err := prepareHermesHome(homeA, sharedHome, false, skills, nil, filepath.Join(stateRoot, "agent-a", "default"), "", nil, testLogger()); err != nil {
	...
	if _, err := prepareHermesHome(homeB, sharedHome, false, skills, nil, filepath.Join(stateRoot, "agent-b", "default"), "", nil, testLogger()); err != nil {
